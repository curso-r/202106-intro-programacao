...
tarefas <- c("1-introducao", "2-tabelas", "3-filtros", "4-loops", "5-funcoes", "6-pipe")
```
...
porcentagem_sala_respondeu <- round(n_respondentes/ params$tamanho_sala * 100, 1)
```
